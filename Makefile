...
南昌方言詞典.mdx: mdx/dict.txt src/make_mdx_txt.rb
	mdict --title mdx/title.html --description mdx/description.html -a mdx/dict.txt lancoong/南昌方言詞典.mdx

mdx/dict.txt:
	ruby ./src/make_mdx_txt.rb > mdx/dict.txt

南昌方言詞典.mdd: mdd/*
	mdict --title mdx/title.html --description mdx/description.html -a mdd lancoong/南昌方言詞典.mdd
